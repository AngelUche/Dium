    ...
    <div className=" h-max  py-2 pt-8 border-b-2 border-2">
      ...
      <ul className="flex gap-[1px] justify-center items-center hover:cursor-pointer" >
        ...
        <ul className="flex gap-x-7  justify-center items-center">
          ...
          <input type='text' value={searchvalue} id="search" onChange={(e)=>setSearchValue(e.target.value)}  className="text-black text-end focus:outline-none  border-[1px] rounded-md border-gray-200 px-3 w-[100%]  " />
          </div>
