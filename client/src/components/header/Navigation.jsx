  ...
  return (
    <div className=" h-max  py-2 pt-8 border-b-2 border-2">
      <header className="flex flex-row justify-evenly items-center">
        <ul
          className="flex gap-[1px] justify-center items-center hover:cursor-pointer"
        ...
        <ul className="flex justify-between gap-x-6">
          <li>
            ...
            justify-start items-center gap-5 
             ${
               isActive
                 ? "text-[#311180]  border-b-2 border-[#311180] font-[550]"
                 : undefined
             }`
              }
            >
          ...
          <li>
            ...
            justify-start items-center gap-5
             ${
               isActive
                 ? "  text-[#311180]  border-b-2 border-[#311180] font-font-[550]"
                 : undefined
             }`
              }
            >
        ...
        <ul className="flex gap-x-7  justify-center items-center">
          <div className="relative  flex justify-around items-center box-border bg-red-40 w-[130px]">
            ...
            <input
              ...
              className="text-black text-end focus:outline-none  border-[1px] rounded-md border-gray-200 px-3 pl-6 w-[100%]  "
            />
          </div>
          ...
          <NavLink to="/register">
            <button className="px-5 py-[6px] rounded-[13px] text-white text-[12px] bg-[#311180]  ">
              Get started
            </button>
          </NavLink>
        </ul>
